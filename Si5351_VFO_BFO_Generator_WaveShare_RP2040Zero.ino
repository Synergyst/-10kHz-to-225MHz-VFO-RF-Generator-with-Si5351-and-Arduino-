...
#define LED_PIN 16    // Change to your data pin
#define LED_COUNT 1   // Number of LEDs in your strip
#define IS_RGBW true  // Set true if your LEDs are RGBW (SK6812)
#if IS_RGBW
...
#define BAUD 9600       // SoftSerial and Serial baud rates
